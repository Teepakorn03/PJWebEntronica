...
@section('content')
  ...
  <div align="right" class="col-xs-10">
        {{ Html::link('Album2/create', 'Add New', array(
...
<table align="center" class="table table-bordered" style="width:70%;">
  ...
  <tbody>
    <tr>
      ...
      <td>
          {{ Html::link('Album2/'.$p['id'].'/edit', 'Edit', array('class'=> 'btn btn-primary')) }}
          {{ Form::open(['route' => ['Album2.destroy',$p['id'], 'method' => "DELETE"] ]) }}
