...
@section('content')
  ...
  <div align="right" class="col-xs-10">
        {{ Html::link('Album8/create', 'Add New', array(
...
<table align="center" class="table table-bordered" style="width:70%;">
  ...
  <tbody>
    <tr>
      ...
      <td>
          {{ Html::link('Album8/'.$p['id'].'/edit', 'Edit', array('class'=> 'btn btn-primary')) }}
          {{ Form::open(['route' => ['Album8.destroy',$p['id'], 'method' => "DELETE"] ]) }}
