...
<div class="panel panel-primary">
    ...
    @if(isset($detail))
          {{  Form::open(['method'=>'PATCH', 'enctype'=>'multipart/form-data', 'route' => ['DetailJobTh.update', $detail->id]])}}
    @else
          {{  Form::open(['method'=>'POST', 'enctype'=>'multipart/form-data', 'url' => 'DetailJobTh'])}}
    @endif
