...
@section('content')
  ...
  <div align="right" class="col-xs-10">
        {{ Html::link('Album6/create', 'Add New', array(
  ...
  <tbody>
    <tr>
      ...
      <td>
          ...
          {{ Form::open(['route' => ['Album6.destroy',$p['id'], 'method' => "DELETE"] ]) }}
          <input type="hidden" name="_method" value="delete" />
          {{ Html::link('Album6/'.$p['id'].'/edit', 'Edit', array('class'=> 'btn btn-primary')) }} &nbsp;
